...
function sidebar_open(id) {
	...
	if(is_show) {
		...
		switch(id) {
			case 'sidebar-response'	: $('#' + id + '-top').load(sidebar_url + '/response.php'); break;
			case 'sidebar-cart'		: $('#' + id + '-top').load(sidebar_url + '/cart.php'); break;
		}
...
function sidebar_empty(id) {
	...
	// Ajax
	switch(id) {
		case 'sidebar-cart' : $('#' + id + '-top').load(sidebar_url + '/cart.php?del=1'); break;
	}
